...
mrb_value main_obj;
void mrb_main_gem_init(mrb_state* mrb);
void mrb_main_gem_final(mrb_state* mrb);
...
static void mruby_init()
{
	...
	mrb_init(mrb, mrb_default_allocf, NULL);

	mrb_init_mrbgems(mrb);
	mrb_main_gem_init(mrb);
