 ...
 * 
 *  @(#) $Id: tinet_app_config.h 976 2016-06-23 00:31:31Z coas-nagasima $
 */
...
#define IPV4_ADDR_LOCAL			MAKE_IPV4_ADDR(192,168,2,110)
#define IPV4_ADDR_LOCAL_MASK		MAKE_IPV4_ADDR(255,255,255,0)
#define IPV4_ADDR_DEFAULT_GW		MAKE_IPV4_ADDR(192,168,2,1)
